...
import { Container, Wrapper, Title, Desc, CardContainer, ToggleButtonGroup, ToggleButton, Divider } from './styled';
    ...
    <Container id="projects">
      <Wrapper>
        ...
        <ToggleButtonGroup>
          ...
          <Divider />
          {toggle === 'mobile app' ? (
            <ToggleButton active value="mobile app" onClick={() => setToggle('mobile app')}>
              MOBILE APP'S
            </ToggleButton>
          ) : (
